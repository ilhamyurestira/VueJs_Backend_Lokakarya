<template>
  ...
  <Dialog v-if="showPaymentModal" v-model:visible="showPaymentModal" modal header="Informasi Rekening"
    ...
    <div style="text-align: center; line-height: 1; font-size: 20px; margin-top: 10px">
      ...
      <p>Bulan Tagihan: {{ getNamaBulan(accountInfo.bulanTagihan) }}</p>
      <p>Tahun Tagihan: {{ accountInfo.tahunTagihan }}</p>
    ...
    async getAccountInfo() {
      ...
      try {
        ...
        this.accountInfo = {
          ...
          bulanTagihan: response.data.bulanTagihan,
          tahunTagihan: response.data.tahunTagihan
