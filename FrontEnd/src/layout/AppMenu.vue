...
const model = ref([
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Transaksi Nasabah', icon: 'pi pi-fw pi-check-square', to: '/bankadm/transaksiNasabah' },
            { label: 'Histori Nasabah', icon: 'pi pi-fw pi-bookmark', to: '/bankadm/historyBank' }
            ]
    },
    {
        label: 'Telpon Admin',
